...
- [ ] DeleteServiceModal 建立（確認刪除）
- [ ] RollbackModal 建立（選擇 revision）
- [ ] EditDomainModal 建立（編輯自訂網域）
- [ ] Delete 操作成功後導航回 workspace
- [ ] Rollback 操作成功後刷新頁面
- [ ] Domain 編輯成功後更新顯示
...
- [ ] Delete modal 正確顯示並執行刪除
- [ ] Rollback modal 顯示 revision history
- [ ] Rollback 執行成功並更新狀態
- [ ] Domain 編輯成功並更新顯示
- [ ] 所有 modal 有適當的載入狀態
- [ ] 錯誤處理正確顯示錯誤訊息
